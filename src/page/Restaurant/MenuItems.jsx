...
const MenuItems = () => {
  ...
  const handleDelete = (id) => {
    axios
      .delete(`${server}/menu/delete/${id}`, { withCredentials: true })
      .then((res) => {
  ...
  const handleEditClick = (item) => {
    setEdit(true), setSelectItem(item);
  };
  return (
        ...
        <div className=" flex justify-between">
          <div className=" relative w-[50%]">
            <input
              ...
              className="w-full border border-gray-200 p-2 focus:outline-none focus:ring-2 focus:ring-green-600"
            />
            <BiSearchAlt
              size={25}
